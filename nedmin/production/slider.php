...
$slidersor=$db->prepare("SELECT * FROM carusel");
$slidersor->execute();
      ...
      <div class="col-md-12 col-sm-12 col-xs-12">
        <div class="x_panel">
          <div class="x_title">
            ...
            <div align="right">
              <a href="slider-ekle.php"><button class="btn btn-success btn-xs"> Yenisini Əlavə Elə</button></a>
            ...
            <table id="datatable-responsive" class="table table-striped table-bordered dt-responsive nowrap" cellspacing="0" width="100%">
              ...
              <tbody>
                ...
                <tr>
                 ...
                 <td><img width="200" src="../../<?php echo $slidercek['slider_src'] ?>"></td>
