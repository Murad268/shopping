  ...
  <div class="">
    ...
    <div class="row">
      <div class="col-md-12 col-sm-12 col-xs-12">
        <div class="x_panel">
          <div class="x_title">
            <h2>Bank Hesablarını Listeleme <small>,
            ...
            <div align="right">
              <a href="banka-ekle.php"><button class="btn btn-success btn-xs"> Yeni Əlavə Elə</button></a>
          ...
          <div class="x_content">
            ...
            <td><center><a href="banka-duzenle.php?banka_id=<?php echo $bankacek['banka_id']; ?>"><button class="btn btn-primary btn-xs">Yenilə</button></a></center></td>
